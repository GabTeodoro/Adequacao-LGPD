...
public class CadastroQuestaoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(acao.equalsIgnoreCase("AddQuestion")) {
		...
		}else if (acao.equalsIgnoreCase("AddQuestionTrueOrFalse")){
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher("cadastroQuestaoVerdFalso.jsp");
			dispatcher.forward(request, response);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String verdadeiro = request.getParameter("verdadeiro");
		String falso = request.getParameter("falso");
		...
		if (id == null || id.isEmpty()) {
			...
			if(verdadeiro == null || verdadeiro.isEmpty() && falso == null || falso.isEmpty()) {
